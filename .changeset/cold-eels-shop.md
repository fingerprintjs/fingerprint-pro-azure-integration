...
Migrate to a **Flex Consumption** plan.
...
- In order to use the new plan, you need to re-deploy the function app using the v2 version. [See the migration guide for details.](https://docs.fingerprint.com/docs/azure-proxy-integration-migration-from-v1-to-v2)
