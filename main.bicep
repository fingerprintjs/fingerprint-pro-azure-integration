...
var appInsightsName = 'fingerprint-pro-azure-integration-AppInsights'
var storageAccountName = 'fnstor${replace(appNameSuffix, '-', '')}'
var functionNameComputed = 'fingerprint-pro-azure-integration'
var functionRuntime = 'nodejs'
var keyVaultName = 'kv${replace(appNameSuffix, '-', '')}'
var functionAppKeySecretName = 'fingerprint-pro-azure-integration-secret'
...
resource function 'Microsoft.Web/sites/functions@2020-12-01' = {
  ...
  properties: {
    ...
    files: {
      'run.js': loadTextContent('dist/fingerprintjs-pro-azure-function/fingerprintjs-pro-azure-function.js')
    }
  }
}
